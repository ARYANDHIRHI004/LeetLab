...
const HomePage = () => {
  ...
  const {getAllProblems, getProblemId, problems,isProblemsLoading} = useProblemStore()
  ...
  return (
    <section className="min-h-screen flex flex-col items-center mt-14 px-4">
      ...
      <h1 className="text-4xl font-extrabold z-10 text-center">
        Welcome to <span className="text-primary">Neurocodium</span>
      </h1>
      ...
      {
        problems.length > 0 ?<ProblemTable problems={problems}/>: <p>not found</p>
      }
